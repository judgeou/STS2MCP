...
async def combat_play_card(
    ...
    Indices shift after every play — use the merged state for the next ``card_index``. Playing from
    highest index to lowest (right to left) often keeps remaining indices more stable.
    """
